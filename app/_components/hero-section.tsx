  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid w-full max-w-6xl gap-12 px-6 py-20 sm:py-28 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div>
          <p
            className="animate-fade-up inline-flex items-center gap-2 rounded-full bg-secondary px-4 py-1.5 text-sm font-medium text-secondary-foreground"
          ...
          <h1
            className="animate-fade-up mt-6 font-heading text-4xl leading-[1.1] font-semibold tracking-tight text-balance text-primary sm:text-5xl lg:text-6xl"
        ...
        <div
          className="animate-fade-up relative mx-auto flex aspect-square w-full max-w-sm items-center justify-center"
